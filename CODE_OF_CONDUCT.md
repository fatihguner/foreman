...
We as members, contributors, and maintainers pledge to make participation in the Foreman project and community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
- Writing with precision and professionalism consistent with the project's voice
...
- Deliberately introducing malicious content, misinformation, or misleading frameworks into skill files or other project content
...
This Code of Conduct applies within all project spaces, including the GitHub repository, issue tracker, pull requests, discussions, and any other communication channel associated with Foreman. It also applies when an individual is officially representing the project in public spaces.
...
**Fatih Guner** — fatihguner (at GitHub)
