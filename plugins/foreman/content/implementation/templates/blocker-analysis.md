...
description: "Produces a structured root-cause analysis of one or more blockers
  preventing implementation progress. Goes beyond surface identification to
  apply the five-whys technique, assess downstream impact, recommend specific
  resolution paths through the Foreman system, and define escalation triggers.
  Use when a blocker persists beyond one check-in cycle or when multiple
  blockers share a common root cause that warrants deeper investigation."
audience: "self"
applicable_skills:
