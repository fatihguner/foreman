...
export function runStateCLI(args) {
  ...
  if (command === 'resume') {
    if (opts.playbook !== undefined || opts.step !== undefined) return mutate(s=>{identifier(opts.playbook);s.active.playbook={id:opts.playbook,next_step:Number(opts.step)};return s;});
    return readState(workspace,founder).active.playbook;
  }
