...
description: "Guides entrepreneurs through researching and diagnosing customer
  churn — calculating accurate churn metrics, building cohort retention curves,
  running exit surveys, correlating usage data with attrition, and synthesizing
  findings into actionable churn drivers."
...
related_content:
  - kind: diagnostic
    ref: customer-churn-diagnosis
  - kind: diagnostic
    ref: revenue-diagnosis
  - kind: playbook
    ref: pricing-strategy-playbook
  - kind: template
