...
description: "Comprehensive protocol for planning and executing user and
  usability testing. Covers moderated and unmoderated testing, task-based
  protocols, think-aloud method, A/B testing, prototype testing, and first-click
  testing with structured note-taking templates."
...
related_content:
  ...
  - kind: playbook
    ref: product-market-fit-playbook
  - kind: template
    ref: new-initiative-brief
  - kind: diagnostic
    ref: product-market-fit-diagnosis
---
