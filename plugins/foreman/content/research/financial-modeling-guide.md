...
description: "Guides entrepreneurs through gathering the inputs required to
  build a financial projection — revenue build-up, expense modeling, cash flow
  projection, break-even analysis, and scenario stress-testing. Produces the
  assumption set that drives a defensible financial model."
