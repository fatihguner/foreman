...
> Runtime note: These layers describe conceptual and legacy memory. Current writes use the versioned state and migration protocol in `.claude/RUNTIME.md`. Do not create a second active store.
