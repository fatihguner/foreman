...
description: "Structures the complete process of building stakeholder alignment
  for a strategic initiative. Chains stakeholder mapping, resistance diagnosis,
  coalition design, influence strategy, communication planning, and
  implementation into a rigorous sequence with checkpoints and a critical
  decision point. Use when an entrepreneur must secure organizational support
  for a significant change -- a pivot, a new hire, a budget reallocation, a
  strategic partnership, or any initiative requiring multiple stakeholders to
  say yes."
version: "1.0.0"
category: "playbooks"
...
steps:
  - skill: "coalition-and-partnership-games"
    ...
    output: "Stakeholder influence map with position, power, and interest per
      stakeholder"
  - purpose: "Diagnose root cause of resistance for each skeptic and blocker"
    output: "Resistance diagnosis per stakeholder with root cause and engagement
      recommendation"
    kind: diagnostic
    ref: stakeholder-resistance-diagnosis
  - skill: "coalition-and-partnership-games"
  ...
  - skill: "cialdini-influence"
    ...
    output: "Influence strategy per stakeholder with principles, tactics, and
      ethical guardrails"
  - skill: "persuasion-and-influence"
    purpose: "Design the communication plan -- what to say, when, to whom, through
      which channel"
    output: "Communication plan with messaging matrix, timing, and feedback loops"
  - purpose: "Execute with accountability -- track engagements, monitor position
      changes, adapt"
    output: "Action plan with tracked items, milestones, and check-in protocol"
    kind: implementation
    ref: implementation-tracking
final_outputs:
