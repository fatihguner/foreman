...
trigger_patterns:
  ...
  - Same old approaches
  - Need fresh thinking
  - How do I get creative again?
  - We're not experimenting enough
  - Nobody takes risks anymore
  - Our product hasn't evolved in months
  - Competitors are out-innovating us
  - Brainstorming sessions produce nothing useful
routes_to:
  diagnostics:
    - innovation-drought-diagnosis
  playbooks:
    - innovation-sprint-playbook
  skills:
...
IF intent == creativity-drought OR founder-creative-block:
  ...
  → skills/creative/creative-identity-and-purpose.md
  → skills/creative/creative-obstacles.md
  → skills/decisions/generating-solutions

IF intent == risk-aversion:
  → diagnostics/innovation-drought-diagnosis
  → skills/thinking/enemies-of-clear-thinking
  → skills/creative/creative-practice-and-habit.md
...
IF intent == ideation-process-failure:
  → diagnostics/innovation-drought-diagnosis
  → skills/decisions/generating-solutions
  → skills/decisions/generating-solutions.md
  → skills/creative/creative-collaboration-and-context.md
```
