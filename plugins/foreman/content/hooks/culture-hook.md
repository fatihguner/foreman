...
trigger_patterns:
  ...
  - Values mean nothing here
  - New hires don't fit
  - We've lost our identity
  - Remote killed our culture
  - People don't care anymore
  - It used to feel different
  - We're just a job now
  - Nobody lives our values
  - The vibe has completely changed
  - Culture doesn't scale
  - We hired too fast and lost something
routes_to:
  diagnostics:
...
IF intent == culture-fit-mismatch:
  ...
  → output-templates/team/hiring-scorecard.md
...
IF intent == meaning-deficit:
  → diagnostics/culture-erosion-diagnosis
  → skills/frameworks/organisational-culture.md
  → skills/leadership/purpose-driven-leadership.md
