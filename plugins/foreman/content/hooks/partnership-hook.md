...
trigger_patterns:
  ...
  - Equity split fight
  - Joint venture?
  - Acquisition offer came in
  - My cofounder wants out
  - Thinking about bringing on a cofounder
  - Our partner is competing with us
  - How do I structure this deal?
  - Vesting schedule dispute
routes_to:
  diagnostics:
    - cofounder-conflict-diagnosis
    - partnership-diagnosis
  templates:
    - unit-economics-snapshot
    - personal-board-tracker
  playbooks:
    - acquisition-evaluation-playbook
...
IF intent == cofounder-conflict:
  ...
  → skills/people/resolving-people-conflict.md
...
IF intent == partner-addition:
  → diagnostics/partnership-diagnosis
  → playbooks/partnership-playbook
  → skills/game-theory/coalition-and-partnership-games.md
