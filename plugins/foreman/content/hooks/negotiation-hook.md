...
trigger_patterns:
  ...
  - Term sheet makes no sense
  - Partner wants too much
  - Contract negotiation
  - They're playing hardball
  - I keep giving in
  - Vendor is squeezing us
  - Salary negotiation with a key hire
  - Licensing terms are unfair
routes_to:
  diagnostics:
    - negotiation-stuck-diagnosis
  templates:
...
IF intent == weak-position-negotiation OR power-asymmetry:
  ...
  → skills/game-theory/prisoners-dilemma-and-cooperation.md

IF intent == term-comprehension:
  → output-templates/self/negotiation-prep-sheet.md
...
IF intent == concession-pattern:
  → diagnostics/negotiation-stuck-diagnosis
  → skills/negotiation/cooperative-negotiation.md
  → skills/negotiation/competitive-negotiation
```
