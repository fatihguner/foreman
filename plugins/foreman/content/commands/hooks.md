...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/navigation-commands.md and execute only /hooks with the user's arguments: $ARGUMENTS.
