...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/solo-command.md and execute only /solo with the user's arguments: $ARGUMENTS.
