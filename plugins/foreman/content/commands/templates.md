...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/navigation-commands.md and execute only /templates with the user's arguments: $ARGUMENTS.
