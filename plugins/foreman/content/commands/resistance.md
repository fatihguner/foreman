...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/org-politics-commands.md and execute only /resistance with the user's arguments: $ARGUMENTS.
