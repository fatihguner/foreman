...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/org-politics-commands.md and execute only /stakeholders with the user's arguments: $ARGUMENTS.
