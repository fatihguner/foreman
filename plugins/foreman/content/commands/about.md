...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/meta-commands.md and execute only /about with the user's arguments: $ARGUMENTS.
