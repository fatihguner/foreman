...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/execution-commands.md and execute only /apply with the user's arguments: $ARGUMENTS.
