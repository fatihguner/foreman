...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/language-command.md and execute only /language with the user's arguments: $ARGUMENTS.
