...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/playbook-commands.md and execute only /skip with the user's arguments: $ARGUMENTS.
