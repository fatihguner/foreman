...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/stoic-command.md and execute only /stoic with the user's arguments: $ARGUMENTS.
