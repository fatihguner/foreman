...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/output-commands.md and execute only /compare with the user's arguments: $ARGUMENTS.
