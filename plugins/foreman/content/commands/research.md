...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/research-commands.md and execute only /research with the user's arguments: $ARGUMENTS.
