...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/meta-commands.md and execute only /stage with the user's arguments: $ARGUMENTS.
