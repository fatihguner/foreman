...
| Validation | Testing with real humans, not just data | Prototyping must include testing the human experience of interacting with the AI, not just the accuracy of the AI's output. User testing should measure trust, control, and emotional response alongside technical metrics. |
...
```markdown
# Human-Centred AI Deployment Plan

## System Overview
- **AI application:** [What the system does]
- **Affected workforce:** [Roles and number of people]
- **Business objective:** [What the AI is meant to achieve]

## Human-Readiness Assessment
| Dimension | Current State | Risk Level | Required Action |
|---|---|---|---|
| Employee agency | [How much control do employees retain?] | [High/Medium/Low] | [Specific action] |
| Human variability | [Does the system accommodate good days and bad days?] | [High/Medium/Low] | [Specific action] |
| Transparency | [Do employees know what data is collected and how it is used?] | [High/Medium/Low] | [Specific action] |
| Override authority | [Can employees question or override AI recommendations?] | [High/Medium/Low] | [Specific action] |
| Meaningful work | [Does the AI enhance or diminish the meaning of the work?] | [High/Medium/Low] | [Specific action] |

## Fear Mitigation Plan
| Hidden Fear | How This Deployment Triggers It | Specific Mitigation |
|---|---|---|
| Loss of control | [Describe] | [Action] |
| Invisibility | [Describe] | [Action] |
| Death of judgment | [Describe] | [Action] |
| Surveillance | [Describe] | [Action] |
| Leadership silence | [Describe] | [Action] |

## Feedback Architecture
- **Frequency:** [How often feedback is collected]
- **Channels:** [Anonymous surveys, team sessions, one-on-ones, override logs]
- **Escalation path:** [What happens when feedback reveals a problem]
- **Commitment:** [How the organisation will respond to feedback]

## Success Metrics (Human and Business)
| Metric | Target | Measurement Method |
|---|---|---|
| [Business metric -- e.g., throughput] | [Target] | [How measured] |
| [Human metric -- e.g., employee satisfaction] | [Target] | [How measured] |
| [Human metric -- e.g., turnover rate] | [Target] | [How measured] |
| [Human metric -- e.g., override frequency] | [Target] | [How measured] |
```
...
- **[AI Stakeholder Balance](../../content/skills/ai-leadership/ai-stakeholder-balance.md)** -- The human-centred approach operationalises stakeholder balance at the employee level, translating broad ethical principles into specific workforce practices.
- **[AI Augmentation Not Automation](../../content/skills/ai-leadership/ai-augmentation-not-automation.md)** -- Augmentation is the natural extension of human-centred design: AI that enhances human capability rather than supplanting it.
- **[AI Emotional Intelligence](../../content/skills/ai-leadership/ai-emotional-intelligence.md)** -- Leading a human-centred AI deployment requires the emotional intelligence to perceive and respond to employee fears that are rarely articulated directly.
- **[Psychological Safety](../../content/skills/frameworks/psychological-safety.md)** -- Employees who do not feel psychologically safe will not provide honest feedback about their AI experience, rendering the entire feedback architecture useless.
- **[Employee Engagement and Retention](../../content/skills/leadership/employee-engagement-retention.md)** -- The human-centred approach is, at its core, an engagement and retention strategy specific to the AI context.
- **[Leading Through Change](../../content/skills/leadership/leading-through-change.md)** -- General change leadership provides the foundation; this skill adapts those principles to the specific psychological dynamics of AI-driven transformation.
