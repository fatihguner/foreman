...
**Prompt 1 -- Default Diagnosis:**
> I just made (or am about to make) this decision: [describe decision]. Analyse it through the four-default lens. For each default (emotion, ego, social, inertia), assess whether it is likely influencing my thinking. Identify the specific trigger, the default behaviour it would produce, and what the clear-thinking alternative would look like. Be direct -- I need honesty, not comfort.

**Prompt 2 -- Ordinary Moment Audit:**
> Review my last week of decisions and reactions: [describe 5-7 recent decisions, including small ones]. Identify which ones were "ordinary moments" where a default likely took control without my awareness. For each, name the default, describe what clear thinking would have produced instead, and estimate the cumulative cost of these unforced errors.

**Prompt 3 -- Default Vulnerability Map:**
> Based on my current situation -- [describe stage, stressors, team dynamics, recent events] -- build a vulnerability map showing which defaults I am most susceptible to right now and why. Include biological amplifiers (sleep, stress, fatigue levels). Then recommend three specific environmental changes or rules that would reduce my exposure to the most dangerous default.

**Prompt 4 -- Compounding Default Analysis:**
> Analyse this ongoing situation: [describe a persistent problem or stuck decision]. Map how multiple defaults may be compounding to keep me locked in a suboptimal position. Trace the chain: which default started the pattern, which ones reinforced it, and what would breaking one link in the chain look like in practice?
...
| Stage | Primary Default Risk | Key Difference |
|-------|---------------------|----------------|
| Idea | Ego + Social | The ego default inflates confidence in an untested concept; the social default either validates it through echo-chamber feedback or kills it through premature conformity to "realistic" expectations. |
| Validation | Emotion + Ego | Negative signals from early customers trigger the emotion default (defensiveness) and the ego default (dismissing feedback). The founder's identity is maximally entangled with the product at this stage. |
...
```markdown
# Default Diagnosis -- [Decision or Situation]
...
| Default | Active? | Trigger | Evidence | Severity |
|---------|---------|---------|----------|----------|
| Emotion | [Y/N] | [What triggered it] | [Observable behaviour] | [H/M/L] |
| Ego | [Y/N] | [What triggered it] | [Observable behaviour] | [H/M/L] |
| Social | [Y/N] | [What triggered it] | [Observable behaviour] | [H/M/L] |
| Inertia | [Y/N] | [What triggered it] | [Observable behaviour] | [H/M/L] |

## Biological Amplifiers
- Sleep: [Hours last 3 nights]
- Stress level: [H/M/L]
- Recent emotional event: [Y/N -- describe]
- Environment: [Familiar / Unfamiliar]

## Compounding Analysis
[Describe how multiple defaults may be reinforcing each other]

## Clear-Thinking Alternative
[What the decision or response would look like if no default were operating]

## Safeguard Recommendation
1. [Specific environmental change or rule]
2. [Specific environmental change or rule]
3. [Specific environmental change or rule]

## Ordinary Moment Assessment
- **Is this moment ordinary or dramatic?** [Most consequential moments feel ordinary]
- **Will this response make the future easier or harder?** [The framework's core test]
```
...
- **[Building Thinking Strength](../../content/skills/thinking/building-thinking-strength.md)** -- Diagnosing defaults is the first step; building the four internal strengths is how you override them consistently.
- **[Managing Weakness and Mistakes](../../content/skills/thinking/managing-weakness-and-mistakes.md)** -- When defaults win despite awareness, safeguards and mistake-handling protocols limit the damage and extract learning.
- **[Thinking, Fast and Slow](../../content/skills/frameworks/thinking-fast-and-slow.md)** -- Kahneman's System 1/System 2 model provides the cognitive science foundation; the four defaults operationalise it into specific behavioural patterns entrepreneurs can recognise.
- **[Decision-Making Under Pressure](../../content/skills/leadership/decision-making-under-pressure.md)** -- Offers the daily decision habits that complement the deeper diagnostic system, particularly the importance-frequency matrix.
- **[Stoic Control and Clarity](../../content/skills/stoic/stoic-control-and-clarity.md)** -- The Stoic dichotomy of control achieves clarity by distinguishing what can and cannot be influenced; the Clear Thinking framework achieves it by identifying which biological programme is doing the influencing.
- **[Stoic Emotional Mastery](../../content/skills/stoic/stoic-emotional-mastery.md)** -- Provides the philosophical discipline for managing the emotion default specifically, complementing the behavioural and environmental approach.
- **[Stoic Unbiased Thought](../../content/skills/stoic/stoic-unbiased-thought.md)** -- The Stoic impression-testing protocol is the ancient ancestor of the modern default-interruption techniques; both aim to create a gap between stimulus and response.
