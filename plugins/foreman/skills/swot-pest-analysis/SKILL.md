...
- **[Porter's Five Forces](../../content/skills/frameworks/porters-five-forces.md)** -- Provides the competitive intensity analysis that feeds into SWOT's Threats and Opportunities quadrants.
- **[Blue Ocean Strategy](../../content/skills/frameworks/blue-ocean-strategy.md)** -- Builds on SWOT by asking not just where you stand, but where uncontested market space exists.
- **[Balanced Scorecard](../../content/skills/frameworks/balanced-scorecard.md)** -- Translates SWOT-derived strategies into measurable objectives across four performance dimensions.
- **[Scenario Planning](../../content/skills/frameworks/scenario-planning.md)** -- PEST identifies the driving forces that scenario planning uses as axes; SWOT reveals how the organization would perform under each resulting scenario.
- **[Systems Thinking](../../content/skills/frameworks/systems-thinking.md)** -- Systems thinking reveals how the factors identified in SWOT and PEST interact dynamically over time, preventing static analysis from producing brittle strategies.
- **[Strategic Thinking and Alignment](../../content/skills/leadership/strategic-thinking-and-alignment.md)** -- SWOT and PEST provide the analytical inputs; strategic thinking translates those inputs into coherent organizational direction and resource allocation.
