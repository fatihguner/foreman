---
description: "Foreman /stage command"
generated: true
...
Read ${CLAUDE_PLUGIN_ROOT}/content/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/content/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/content/command-guides/meta-commands.md and execute only /stage with the user's arguments: $ARGUMENTS.
