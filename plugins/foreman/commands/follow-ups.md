---
description: "Foreman /follow-ups command"
generated: true
...
Read ${CLAUDE_PLUGIN_ROOT}/content/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/content/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/content/command-guides/memory-commands.md and execute only /follow-ups with the user's arguments: $ARGUMENTS.
