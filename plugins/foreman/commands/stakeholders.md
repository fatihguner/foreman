---
description: "Foreman /stakeholders command"
generated: true
argument-hint: "[arguments]"
---

# Foreman /stakeholders

Read ${CLAUDE_PLUGIN_ROOT}/content/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/content/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/content/command-guides/org-politics-commands.md and execute only /stakeholders with the user's arguments: $ARGUMENTS.
