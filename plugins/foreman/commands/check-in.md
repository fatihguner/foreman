---
description: "Foreman /check-in command"
generated: true
...
Read ${CLAUDE_PLUGIN_ROOT}/content/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/content/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/content/command-guides/implementation-commands.md and execute only /check-in with the user's arguments: $ARGUMENTS.
