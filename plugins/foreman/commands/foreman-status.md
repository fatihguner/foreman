---
description: "Foreman /status command"
generated: true
...
Read ${CLAUDE_PLUGIN_ROOT}/content/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/content/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/content/command-guides/playbook-commands.md and execute only /status with the user's arguments: $ARGUMENTS.
