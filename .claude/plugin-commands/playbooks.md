...
Read ${CLAUDE_PLUGIN_ROOT}/.claude/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/.claude/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/.claude/command-guides/navigation-commands.md and execute only /playbooks with the user's arguments: $ARGUMENTS.
