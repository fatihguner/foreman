...
Read ${CLAUDE_PLUGIN_ROOT}/.claude/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/.claude/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/.claude/commands/meta-commands.md and execute only /feedback with the user's arguments: $ARGUMENTS.
