...
Read ${CLAUDE_PLUGIN_ROOT}/.claude/RUNTIME.md and ${CLAUDE_PLUGIN_ROOT}/.claude/policies/advisory.md first. Then read ${CLAUDE_PLUGIN_ROOT}/.claude/command-guides/org-politics-commands.md and execute only /coalition with the user's arguments: $ARGUMENTS.
