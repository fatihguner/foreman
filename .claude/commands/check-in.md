...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/implementation-commands.md and execute only /check-in with the user's arguments: $ARGUMENTS.
