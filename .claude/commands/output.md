...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/execution-commands.md and execute only /output with the user's arguments: $ARGUMENTS.
