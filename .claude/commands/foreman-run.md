...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/execution-commands.md and execute only /run with the user's arguments: $ARGUMENTS.
