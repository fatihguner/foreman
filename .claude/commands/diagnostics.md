...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/navigation-commands.md and execute only /diagnostics with the user's arguments: $ARGUMENTS.
