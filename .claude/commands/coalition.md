...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/org-politics-commands.md and execute only /coalition with the user's arguments: $ARGUMENTS.
