...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/research-commands.md and execute only /research with the user's arguments: $ARGUMENTS.
