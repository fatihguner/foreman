...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/org-politics-commands.md and execute only /power-map with the user's arguments: $ARGUMENTS.
