...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/implementation-commands.md and execute only /blockers with the user's arguments: $ARGUMENTS.
