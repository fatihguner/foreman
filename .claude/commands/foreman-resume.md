...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/command-guides/execution-commands.md and execute only /resume with the user's arguments: $ARGUMENTS.
