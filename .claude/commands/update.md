...
Read .claude/RUNTIME.md and .claude/policies/advisory.md first. Then read .claude/commands/memory-commands.md and execute only /update with the user's arguments: $ARGUMENTS.
